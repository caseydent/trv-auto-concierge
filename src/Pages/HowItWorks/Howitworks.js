...
const Howitworks = () => {
    ...
    const images = [
        'https://res.cloudinary.com/dqoibnakh/image/upload/v1719219481/Cadillac_Front_ykjemc.png',
        'https://res.cloudinary.com/dqoibnakh/image/upload/v1719219429/Cadillac_ypfjp5.png',
        'https://res.cloudinary.com/dqoibnakh/image/upload/v1719221331/Cadillac_Back_vbluwb.png',
        'https://res.cloudinary.com/dqoibnakh/image/upload/v1719219235/Cadillac_Interior_Seats_zi9ope.png',
        'https://res.cloudinary.com/dqoibnakh/image/upload/v1719219318/Cadillac_Dashboard_Interior_ih72r7.png'
